...
<body class="<?php print $classes . ' language_' . $language->language; ?>">
      ...
      <div id="content" class="column"><div class="section">
        ...
        <div id="content-area">
			<div id="divContactContent">
				<div id="divContactTop" class="generalTopRounded"></div>
				<div id="divContactMiddle" class="generalMiddleRounded">
					<div id="divSeguinosEnFacebook">
						<a href="http://www.facebook.com/group.php?gid=124379110926655&amp;v=wall" id="aSeguinosEnFacebook" target="_blank">
							<img alt="Seguinos en facebook" height="49px" src="http://artecordobes.com/cn-facebook.png" width="135px" />
						</a>
					</div>
					<div id="divContentForm"><?php print $content; ?></div></div>
				<div id="divContactBottom" class="generalBottomRounded"></div>
			</div>
